        ...
        <div className="relative mx-auto max-w-6xl px-6 py-20 sm:py-24">
          <div className="max-w-3xl">
            ...
            <p className="mt-5 max-w-2xl text-pretty text-base leading-relaxed text-slate-200 sm:text-lg">
              {
                "Join the team at AKEN, a brand of A K ENGINEERING. We are looking for driven engineers, safety officers, and master fabricators to help us execute Eastern India's most complex structural projects."
              }
            </p>
